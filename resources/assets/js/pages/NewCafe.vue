        ...
        <div class="grid-container">
            <div class="grid-x grid-padding-x">
                <div class="large-12 medium-12 small-12 cell">
                    ...
                    <span class="validation" v-show="!validations.name.is_valid">{{validations.name.text}}
        ...
        methods: {
            ...
            validateNewCafe: function(){
              ...
              if(this.address.trim() ===''){
                ...
                this.validations.address.text ='请输入地址信息';
              }else{
              ...
              if(this.city.trim() ===''){
                ...
                this.validations.city.text='请输入城市信息';
              }else{
              ...
              if(this.state.trim()===''){
                ...
                this.validations.state.text='请输入省份信息';
              }else{
